...
class User(UserMixin, db.Model):
    ...
    circles = db.relationship('Circle', backref='author', lazy='dynamic')
...
class Group(db.Model):
    ...
    is_delete = db.Column(db.Boolean, index=False)
    posts = db.relationship('Post', backref='group', lazy='dynamic', primaryjoin='Post.group_id==Group.id')
    circles = db.relationship('Circle', backref='group', lazy='dynamic')
    categorys = db.relationship('Category', backref='category', lazy='dynamic')
...
class Category(db.Model):
    ...
    circles = db.relationship('Circle', backref='category', lazy='dynamic')
    ...
    def to_json(self):
        json_post = {
            ...
            'author': url_for('api.get_user', id=self.author_id,
                              _external=True),
            'circle': url_for('api.get_circle', id=self.circle_id,
                              _external=True),
